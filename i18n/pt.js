module.exports = {
  ...
  "fog_owl.cedric.about_twilio_main": `A <a href='https://www.twilio.com'>Twilio</a> é uma fornecedora de 
  ...
  "fog_owl.cedric.about_world_main_text": `Você está a bordo da nave de exploração na nuvem (CEV) designada <span class='highlight'>Fog Owl</span>.
  Nós 
  somos aproximadamente 1,2 milhão de marcações fora do Meme Cluster, em um local 
  secreto dentro da <span class='highlight'>The Cloud</span>`,
  ...
  <span class='highlight'>Cedric</span> e eu fui designado como seu 
  ...
  <a href='https://www.mistyrobotics.com/'>Misty Robotics</a> para essa finalidade.`,
  ...
  "base.titleScreen.missionBriefing": "resumo da missão",
  "base.titleScreen.back": "Voltar ao título (tecla ESC)",
  "base.titleScreen.audio": "ÁUDIO",
  "base.titleScreen.startGame": "Iniciar jogo (BARRA DE ESPAÇO)",
  "base.titleScreen.unmute": "ATIVAR SOM",
  "base.titleScreen.mute": "DESATIVAR SOM",
  "base.objective.reward": "RECOMPENSA",
  "base.objective.letsDoThis": "Vamos lá!",
  "base.objective.showHelp": "Mostrar ajuda",
  "base.objective.objectiveClear": "* Objetivo definido! *",
  "base.objective.earned": "conquistado!",
  "base.objective.newRank": "Nova classificação",
  "base.objective.reached": "atingida!",
  "base.objective.itemsAwarded": "Itens premiados!",
  "base.objective.viewInInventory": "Exibir no inventário",
  "base.objective.environmentUnlocked": "Variáveis de ambiente desbloqueadas!",
  "base.objective.viewInSettings": "Exibir em configurações",
  "base.objective.xp": "XP",
  "base.validationHelper.accountError": `Parece que você não tem uma conta da Twilio válida configurada. 
  Abra as configurações de IU para conferir as variáveis 
  ...
  "base.validator.true": "Verdadeiro",
  "base.validator.false": "Falso",
  "base.validator.done": "CONCLUÍDO",
  ...
  "base.adventureTeams.leaveTeam": "Sair da equipe",
  "base.adventureTeams.notOnTeam": "Você não está em uma equipe agora.",
  "base.asyncInputBox.success": "Sucesso!",
  "base.asyncInputBox.error": "Erro!",
  "base.audioTab.mute": "Desativar som",
  "base.audioTab.unmute": "Ativar som",
  "base.audioTab.settings": "Configurações de áudio/música",
  "base.credits.team": "Equipe TwilioQuest",
  "base.credits.artwork": "Arte",
  "base.credits.soundtrack": "Trilha sonora",
  "base.credits.emeritus": "Equipe TwilioQuest Emeritus",
  "base.credits.contributors": "Colaboradores de código e tutorial",
  ...
  algum deles, clique em \"Unlock\" (desbloquear) e edite-os usando os campos abaixo.`,
  ...
  "base.extensions.beCareful": "Tenha cuidado!",
  "base.extensions.installExtensions": `Se você instalar extensões
  no TwilioQuest, elas poderão executar o código no
  computador. Confirme se confia no autor da extensão antes de usar esse
  recurso. Extensões danificadas também podem fazer com que o jogo TwilioQuest se torne
  instável, possivelmente exigindo que você reinstale o jogo.`,
  "base.extensions.enableExtensions": "Ativar extensões",
  "base.extensions.extensions": "Extensões",
  "base.extensions.none": "Nenhum",
  "base.operations.join": "Ingressar",
  ...
  "base.settings.userSettings": "Configurações do usuário",
  "base.settings.name": "Nome",
  "base.settings.avatar": "Avatar",
  "base.settings.adventureTeams": "Equipes de aventura",
  "base.settings.adventureCode": `Se você recebeu um código de adesão para a equipe de aventura, digite-o para
  enviar suas conquistas e XP para a tabela de classificação.`,
  "base.settings.joinCode": "Código de adesão",
  "base.settings.operations": "Operações",
  "base.settings.operationCode": `Se você recebeu um código de adesão para operação, digite-o para
  enviar suas conquistas e XP para a tabela de classificação.`,
  "base.settings.changesSaved": "Todas as alterações foram salvas.",
  "base.settings.Audio": "Áudio",
  "base.settings.User": "Usuário",
  "base.settings.Variables": "Variáveis",
  "base.settings.Extensions": "Extensões",
  "base.settings.Teams": "Equipes",
  "base.settings.Operations": "Operações",
  "base.settings.Unlocks": "Desbloqueia",
  "base.settings.Credits": "Créditos",
  "base.unlocksTab.codeRedeemed": "Código já resgatado!",
  "base.unlocksTab.invalidCode": "Código inválido!",
  "base.unlocksTab.redeemed": "Resgatado:",
  "base.unlocksTab.unlockItems": "Desbloquear itens especiais",
  "base.unlocksTab.enterCode": `Você recebeu um código de desbloqueio para um item especial no TwilioQuest?
  Insira o código abaixo para adicionar o item ao seu inventário!`,
  "base.unlocksTab.unlockCode": "Código de desbloqueio",
  "base.unlocksTab.redeem": "Resgatar",
  ...
  "help.discordServer": "Servidor Discord",
  "base.journal.noQuestsFound": "Nenhuma missão encontrada.",
  "base.journal.questJournal": "Diário de missão",
  "base.journal.activeQuests": "Missões ativas",
  "base.journal.completedQuests": "Missões concluídas",
  "base.missionComputer.warpHere": "Prenda aqui",
  "base.missionComputer.locked": "Bloqueado",
  "base.missionComputer.holdUp": "Espere, operador!",
  "base.missionComputer.before": `Antes de assumir esta missão, você deve concluir esses
  objetivos:`,
  "base.missionComputer.launch": "INICIAR MISSÃO",
  "base.missionComputer.warpPoints": "Prender pontos",
  "base.missionComputer.back": "< ANTERIOR",
  ...
  "base.onboardingInterface.press": "Pressione",
  "base.onboardingInterface.enter": "[ENTER]",
  "base.onboardingInterface.to": "para",
  ...
  "base.hudBar.inventory": "Inventário",
  "base.hudBar.journal": "Diário",
  ...
  "base.iframeoverlay.loading": "Carregando... URL:",
  "base.iframeoverlay.errored": "Erro ao carregar URL:",
  "base.iframeoverlay.loaded": "Carregado!",
  "base.iframeoverlay.close": "Fechar",
