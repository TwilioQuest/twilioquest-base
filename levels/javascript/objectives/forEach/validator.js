...
module.exports = async helper => {
  try {
    ...
    if (!exists) {
      helper.fail(`
        We couldn't find your "freightScanner.js" script in your 
    ...
    try {
      ...
      if (isNaN(result)) {
        return helper.fail(`
          ...
          function must return a number, the number of times the string
          "contraband" appeared in the input array.
        `);
      }
    ...
    helper.success(`
      ...
      <span class="highlight">first character</span> in the Infinite Loop's 
